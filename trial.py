...
import random
import build_models
from build_models import process_image
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "For more information, visit the [Ultralytics website](https://ultralytics.com) and check out the [GitHub repository](https://github.com/your-repo-link)."
    )
